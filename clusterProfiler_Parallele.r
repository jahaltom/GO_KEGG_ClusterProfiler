...
setwd(paste("/scr1/users/haltomj/data/30-790208268/DEG/deseq2/out/",f,"/",sep="")) 
...
dme <- pathview(gene.data=kegg_gene_list, pathway.id="hsa01100", out.suffix="Metabolic pathways", species = kegg_organism,kegg.native=FALSE,same.layer=FALSE)
